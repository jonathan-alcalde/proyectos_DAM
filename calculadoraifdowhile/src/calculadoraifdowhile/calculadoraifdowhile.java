package calculadoraifdowhile;

import java.util.Scanner;

public class calculadoraifdowhile {
	...
	public static void main(String[] args) {
		...
		System.out.println("Si quieres realizar otra operación escribe S");
		continuar = escanercalculadora.next().charAt(0);
			}
		}
